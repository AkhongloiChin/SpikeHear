...
class DenseConnection(Connection):
    """Dense connection between groups using nn.Linear operation.
    This is equivalent to Connection with operation=nn.Linear."""
    def __init__(self, src, dst, bias=True, **kwargs):
        super().__init__(src, dst, operation=nn.Linear, bias=bias, **kwargs)